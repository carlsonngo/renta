...
<table class="table table-hover table-striped border bg-white table-bordered">
    <thead>
        <tr>
            ...
            <th class="text-center">{{ trans('backend.amount') }}</th>
            <th class="text-center">{{ trans('backend.type') }}</th>
            <th class="text-center">{{ trans('backend.status') }}</th>
            <th class="text-center">{{ trans('backend.created_at') }}</th>
        </tr>
    </thead>
    <tbody>
        @foreach($rows as $row)
        ...
        <tr class="has-actions">
            ...
            <td class="align-middle text-center">{{ discount_amount($postmeta->amount, $row->post_name) }}</td>
            <td class="align-middle text-center">{{ discount_types($row->post_name) }}</td>
