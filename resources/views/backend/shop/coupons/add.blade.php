    ...
    <div class="row">
        <div class="col-lg-8 col-md-7">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control no-space" value="{{ Input::old('name') }}"> 
            ...
            <div class="row">
                <div class="col form-group">
                    ...
                    {{ Form::select('discount_type', discount_types(), $discount_type = Input::old('discount_type', 'fixed'), ['class' => 'form-control']) }}
