...
<table class="table table-hover table-striped border bg-white table-bordered">
    <thead>
        <tr>
            ...
            <th width="160" class="text-center">{{ trans('backend.count') }}</th>
            ...
            <td>
                ...
                <div class="table-actions small text-uppercase mt-2">
                    ...
                    @else
                        ...
                        @if( has_access($module, ['permission']) )
                        | <a href="{{ URL::route($view.'.permissions', $row->id) }}" class="text-success">{{ trans('backend.manage_permissions') }}</a>
                        @endif
