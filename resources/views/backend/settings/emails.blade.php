    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link {{ actived('premium-registration', Input::get('email') ) }}" href="{{ route('backend.settings.emails', ['email' => 'premium-registration']) }}">Premium Registration</a>
                    
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ actived('standard-registration', Input::get('email') ) }}" href="{{ route('backend.settings.emails', ['email' => 'standard-registration']) }}">Standard Registration</a>
