            ...
            <tbody>
               <tr>
                  <td align="center" id="bodyCell" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding-top:50px;padding-left:20px;padding-bottom:20px;padding-right:20px;border-top:0;height:100%;margin:0;width:100%">
                     <table border="0" cellpadding="0" cellspacing="0" id="templateContainer" width="800" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;border:1px dashed #aaa;background-color:#FFF;border-radius:0">
                        <tbody>
                           <tr>
                                                               ...
                                                               <tr>
                                                                  <td class="kmImageBlockInner" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding:9px;" valign="top">
                                                                     <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmImageContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="kmImageContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding:0;padding-top:20px;padding-bottom:0;padding-left:9px;padding-right:9px;text-align: center;">
                                                                                 <img src="{{ asset(App\Setting::get_setting('site_logo')) }}" style="width:200px;">                                                                                
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
                                                                        ...
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="kmImageContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding:0;padding:0;">
                                                                                 <img align="center" alt="Shadow" class="kmImage" src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/bottom_shadow_222.png" width="800" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom">
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
